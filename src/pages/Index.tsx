      ...
      <section className="py-16 bg-gray-50">
        <div className="container">
          <div className="text-center mb-8">
            <h2 className="text-2xl font-bold mb-4">Try Different User Experiences</h2>
            <p className="text-gray-600 max-w-2xl mx-auto">
              Test our platform from different perspectives. Each user type has a specialized interface designed for their specific needs.
            </p>
          </div>
